    ...
    return (
      <div className="min-h-screen bg-bg-body flex items-center justify-center">
        <div className="text-center">
          <h1 className="text-2xl font-bold text-text-heading mb-2">Profit Tracker</h1>
          <p className="text-text-dim text-[13px] mb-8">Sign in to access your dashboard</p>
          <SignInButton mode="modal">
            <button className="bg-accent hover:bg-accent-hover px-8 py-3 rounded-lg text-[13px] font-semibold text-white transition-colors">
              Sign In
            </button>
          </SignInButton>
        </div>
